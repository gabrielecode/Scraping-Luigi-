  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-lg p-6 hover:border-slate-700 transition-colors space-y-4">
        ...
        {importStatus && (
          <div className="p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-md text-emerald-400 text-xs font-medium flex items-center gap-2">
            ...
            <>
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-4">
                ...
                <div className="text-right">
                  <div className="text-xs font-medium text-slate-400">Totale candidati</div>
                  ...
                  <tbody>
                    {selectedGrad.graduatoria.map((entry, idx) => (
                      <tr key={idx} className="border-b border-slate-800 last:border-b-0 hover:bg-slate-800/50 transition-colors">
                        ...
                        <td className="px-4 py-3 text-center font-mono font-bold text-slate-100 bg-slate-950/40 text-sm">
            ...
            <form onSubmit={handleCreateGraduatoria} className="space-y-4">
              ...
              <div className="space-y-2 pt-2 border-t border-slate-800">
                ...
                <p className="text-xs text-slate-400">
                  Formati supportati: CSV (<code className="text-blue-400">pos;punteggio</code>) o testo tabellare copiato da PDF (<code className="text-blue-400">1 19.80 CANDIDATO</code>). La virgola viene normalizzata automaticamente.
                </p>
              </div>
