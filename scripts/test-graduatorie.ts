...
async function runTests() {
  ...
  assert(
    ...
    "4.1 Più nomine: Nomina 1 (Rossi Mario, CS) risolta correttamente con punteggio 45.2, pos. 1, fascia 1",
    n1
  );
  ...
  assert(
    ...
    "4.1 Più nomine: Nomina 2 (Bianchi Luigi, AA) risolta correttamente con punteggio 62.0, pos. 4, fascia 2",
    n2
  );
  ...
  assert(
    ...
    nNoMatch.posizione_graduatoria === "Da verificare manualmente" &&
    nNoMatch.origine_punteggio === "Non disponibile",
    "4.4 Nessun match: fascia '1' preservata, punteggio e posizione mancanti impostati a 'Da verificare manualmente'",
    nNoMatch
  );
